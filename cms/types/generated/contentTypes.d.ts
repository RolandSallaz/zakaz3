...
export interface ApiCardCard extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    binding_to_rf_number: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    card_types: Schema.Attribute.JSON &
    ...
    publishedAt: Schema.Attribute.DateTime;
    registration_without_power: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    subtitle: Schema.Attribute.String & Schema.Attribute.Required;
    tags: Schema.Attribute.Component<'all.tags', false>;
