...
export default function Card({ title, subtitle, description, tags, price, masterCard, visa, subtags, listItems, upd }: props) {
    return (
            ...
            <div className={`${styles.card__container} ${styles.card__container_top}`}>
                <div className={styles.card__info_container}>
                    ...
                    <div className={styles.images}>
                        ...
                        {visa && <img src={visaImage.src} alt='Иконка виза' className={styles.images__element} style={{ width: '75px', height: '26px' }} />}
                    </div>
                </div>
